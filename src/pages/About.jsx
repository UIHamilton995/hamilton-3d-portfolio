  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          Software Engineer and BlockChain Enthusiast, passionate about building financial applications and solutions that aid easy movement of funds across geographical barriers. I am that teammate with a perfect blend of diligence and humour😁.
        </p>
      </div>
