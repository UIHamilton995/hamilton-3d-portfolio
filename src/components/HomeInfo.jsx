    ...
    return (
      <div className='info-box'>
        <p className='font-medium sm:text-xl text-center'>
          🚀 I have worked on many projects and collaborated with skilled teammates to create fascinating full-stack software solutions, continually improving my abilities along the way.
        </p>
